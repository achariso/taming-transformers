...
from ants.taming.taming.data.image_transforms import convert_pil_to_tensor
...
from ants.taming.taming.data.conditional_builder.utils import COLOR_PALETTE, WHITE, GRAY_75, BLACK, additional_parameters_string, \
